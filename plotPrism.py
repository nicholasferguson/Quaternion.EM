...
#===============================
    ...
    if title == 'a_Right_b_Eqn03':
        ...
        labelA ='antisymmetric(a,B(a,d_dr))'
        labelB ='symmetric(d_dr,E(a,d_dr))'



    ax.plot(pt1x, pt1y, pt1z, markerfacecolor='g', markeredgecolor='k', marker='o', markersize=10, alpha=0.6,label=labelA)
    ax.plot(pt3x, pt3y, pt3z, markerfacecolor='r', markeredgecolor='k', marker='o', markersize=10, alpha=0.6,label=labelB)
    ax.plot(pt2x, pt2y, pt2z, markerfacecolor='b', markeredgecolor='k', marker='o', markersize=10, alpha=0.6,label=labelW)
